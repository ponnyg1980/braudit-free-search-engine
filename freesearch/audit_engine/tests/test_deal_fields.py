...
class Keywords(unittest.TestCase):
    def test_deal_fields_are_the_live_source(self):
        ...
        self.assertEqual(words, [("Exact", "Hailaflo"), ("Similar To", "Hailaflo")])
    ...
    def test_unknown_operator_degrades_to_similar(self):
        d = {"Search_Word_1": "X", "Search_Operator_1": "Sounds Like"}
...
class Exclusions(unittest.TestCase):
    ...
    def test_only_active_rows_and_kinds(self):
        ...
        self.assertEqual(items, [("domain", "zztestwordlogo.example", "Client_Search_Exclusions 1")])
...
class ReaderAssembly(unittest.TestCase):
    ...
    def test_request_carries_image_inputs(self):
        ...
        self.assertEqual(req.extra_criteria, [("Similar To", "Hailaflo")])
...
class ZohoExclusionsWriter(unittest.TestCase):
    ...
    def test_trademark_and_social_rows(self):
        ...
        self.assertEqual(tm["Reason"], "Known False Positive")
...
class SetUpOrderGate(unittest.TestCase):
    def test_send_back_to_setup_payload_and_task(self):
        ...
        try:
            ...
            deal_reader.send_back_to_setup(deal, ["no Nice classes (Classes_Terms subform empty)"])
        finally:
            os.environ.pop("AUDIT_ZOHO_WRITEBACK", None)
